...
- [ ] For macOS package refreshes, read `MAC_RUNNER_HANDOFF.md`.
...
- [ ] If using CI evidence, attach the `readout-macos-package-smoke` artifact and note any remaining manual tray-icon or tray-menu gap.
