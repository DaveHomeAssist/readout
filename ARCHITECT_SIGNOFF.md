...
- Architect decision sign-off is now transcribed from the Notion Architect page. Manual smoke tests still remain for source `/control`, Tk desktop, Chrome extension popup, and audible playback workflows.
